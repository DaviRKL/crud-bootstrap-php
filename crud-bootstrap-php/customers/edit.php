...
<form action="edit.php?id=<?php echo $customer['id']; ?>" method="post">
  ...
  <div class="row">
   ...
   <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" name="customer['birthdate']" value="<?php echo criaData($customer['birthdate']); ?>">
    </div>
  </div>
  <div class="row">
   ...
   <div class="form-group col-md-2">
      ...
      <input type="text" class="form-control" name="customer['created']" disabled value="<?php echo criaData( $customer['created']); ?>">
    </div>
  </div>
  <div class="row">
    <div class="form-group col-md-5">
